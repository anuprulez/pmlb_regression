...
pio.write_image(fig_tp, 'scale_up_plots/fit_time_r2.png', width=1200, height=800)
...
pio.write_image(fig_tp, "scale_up_plots/r2_scores.png", width=1300, height=800)
print("-------------x------------------x---------------")
...
pio.write_image(fig_tp, "scale_up_plots/size_datasets.png", width=1200, height=800)
print("-------------x------------------x---------------")
